...
Final Project: Suitability analysis of shallow vs. deep Neural Networks using the perceptron for classification problems.\\
...
\textbf{2024-2025}: Designer and Sole Developer for the video game adaptation of the board game "Camino a Xibalbá PITZ".
...
\textbf{2023-2024}: Automated Greenhouse for edible mushroom cultivation. Construction of an automated greenhouse featuring humidity and temperature controls, including the complete electrical installation.
...
\textbf{2022-2024}: Mathematics Tutor. Private math tutoring for teenagers and adults.
